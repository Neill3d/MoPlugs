...
//////////////////////////////////////////////////////////////////////////////////////////////////
//
// file: bakeProjectors_projectors.h
//
...
public:
	...
	bool		PrepFull(FBShader *pShader);
	bool		PrepLight();

	bool		Bind(const int shaderFragmentId, const int projectorsUniformLoc, const GLuint muteTextureId) const;
	void		UnBind() const;

	void	ChangeContext()
	{
		mBufferProjectors.ChangeContext();
	}
