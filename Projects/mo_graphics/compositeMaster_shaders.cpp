...
const bool CompositeShaderManagerImpl::CheckAndLoadShader( const ECompositeShader shader, const bool useMask )
{
...
const GLhandleARB CompositeShaderManagerImpl::GetVertexShader()
{
...
{
	mShader = (GLSLShader*) GetShaderPtr( shader, useMask );
	mLocations = (ShaderBaseLocations*) GetShaderLocationsPtr( shader, useMask );
