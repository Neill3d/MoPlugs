...
public:
	...
	const bool			CheckAndLoadShader( const ECompositeShader shader, const bool useMask );
...
private:
	...
	const GLhandleARB	GetVertexShader();
...
public:
	...
	// get specified composite shader for drawing
	const bool			CheckAndLoadShader( const ECompositeShader shader, bool useMask )
	{
