...
/**	\file	orpyfbsdk_template_model.cxx
*/
...
FBClassImplementation( ORModelUser );					                    //!< Register class
FBStorableCustomModelImplementation( ORModelUser, ORMODELUSER__DESCSTR );	//!< Register to the store/retrieve system
FBElementClassImplementation( ORModelUser, FB_DEFAULT_SDK_ICON );			//!< Register to the asset system
