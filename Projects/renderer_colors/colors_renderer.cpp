...
void ColorsRendererCallback::Attach()
{
    ...
    if (mAttachCount == 0)
    {
        ...
        //FBSystem::TheOne().Scene->OnChange.Add (this, (FBCallback) &ColorsRendererCallback::EventSceneChange );

        //FBSystem::TheOne().OnConnectionNotify.Add(this, (FBCallback)&ColorsRendererCallback::EventConnNotify);
        //FBSystem::TheOne().OnConnectionStateNotify.Add(this, (FBCallback)&ColorsRendererCallback::EventConnStateNotify);
        //FBSystem::TheOne().OnConnectionDataNotify.Add(this, (FBCallback)&ColorsRendererCallback::EventConnDataNotify);
...
void ColorsRendererCallback::Detach()
{
    ...
    if (mAttachCount == 0)
    {
		...
		//FBSystem::TheOne().Scene->OnChange.Remove(this, (FBCallback) &ColorsRendererCallback::EventSceneChange );

        //FBSystem::TheOne().OnConnectionNotify.Remove(this, (FBCallback)&ColorsRendererCallback::EventConnNotify);
        //FBSystem::TheOne().OnConnectionStateNotify.Remove(this, (FBCallback)&ColorsRendererCallback::EventConnStateNotify);
        //FBSystem::TheOne().OnConnectionDataNotify.Remove(this, (FBCallback)&ColorsRendererCallback::EventConnDataNotify);
...
void ColorsRendererCallback::RenderNormalizedColors(FBRenderOptions *pRenderOptions)
{
    ...
    while(llDisplayGeometryCount--)
    {
       ...
       //If IDBuffer rendering requested (for display or picking), set model color to be the Model's Unique Color ID.
        ...
        {
			int offset = lModelVertexData->GetSubPatchIndexOffset(i);

			for (int j=0; j<lModelVertexData->GetSubPatchIndexSize(i); j+=3)
			{
